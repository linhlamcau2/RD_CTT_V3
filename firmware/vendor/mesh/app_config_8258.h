...
#else
#define HCI_ACCESS		HCI_USE_UART	//RD_EDIT: enable uart
#endif 

#if (HCI_ACCESS==HCI_USE_UART)			// RD_EDIT:UART_PIN
#define UART_TX_PIN		UART_TX_PD7  //UART_TX_PB1
#define UART_RX_PIN		UART_RX_PA0  //UART_RX_PB0
#endif
#endif
...
//---------------  LED / PWM
#if(PCBA_8258_SEL == PCBA_8258_DONGLE_48PIN)
	#if(NAME == RLT03_12W_12026 || NAME == TRL08_10W_12025 || NAME == TRL08_20W_12024 || NAME == RLT01_10W_12023 || NAME == RLT02_20W_12022 || NAME == RLT02_10W_12021 || NAME == RLT03_06W_12020)		//RD_EDIT: 0.1.THANH PIN GH_XG_RXG
		#define PWM_R       GPIO_PWM5B5		//GPIO_PC4		//Pin 24  Red			//RD_EDIT: pin pwm
		#define PWM_G       GPIO_PWM4B4		//GPIO_PWM1C3		//Pin 23  Green
		#define PWM_B       GPIO_PWM0C2		//Pin 22  Blue
		#define PWM_W       GPIO_PC4		//GPIO_PWM4B4		//Pin 14  White
		#define PWM_Y       GPIO_PWM1C3		//GPIO_PWM5B5		//Pin 15  Yellow
	#else
		#define PWM_R       GPIO_PC4		//Pin 24  Red			//RD_EDIT: pin pwm
		#define PWM_G       GPIO_PWM1C3		//Pin 23  Green
		#define PWM_B       GPIO_PWM0C2		//Pin 22  Blue
		#define PWM_W       GPIO_PWM4B4		//Pin 14  White
		#define PWM_Y       GPIO_PWM5B5		//Pin 15  Yellow
	#endif
#elif(PCBA_8258_SEL == PCBA_8258_C1T140A3_V1_1)
