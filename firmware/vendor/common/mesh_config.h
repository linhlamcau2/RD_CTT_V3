...
#else
#define FAST_PROVISION_ENABLE		 1		//RD_EDIT: 0.1.THANH FAST_PROVISION_ENABLE
#endif
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
#define LIGHT_TYPE_SEL				LIGHT_TYPE_CT	//RD_EDIT: chon loai den
	#endif
#endif
#endif
...
#define FACTORY_TEST_MODE_ENABLE    Flag_Factory_Mode	//RD_EDIT: khoa Factory_Test_Mode
