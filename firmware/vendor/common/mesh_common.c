...
//	foreach(i,sizeof(tbl_scanRsp.rsv_user)){		//RD_EDIT: scan_rsp_init
...
//	flash_read_page(RD_GATEWAY_FLASH_AREA, FLASH_SAVE_TYPE_SIZE, (unsigned char *) (&Flash_Save_Type_Val.Used[0]));
	...
	tbl_scanRsp.rsv_user[0] 	=  0x01;
	tbl_scanRsp.rsv_user[1] 	=  0x02;
	tbl_scanRsp.rsv_user[2]	 	=  NAME;
	tbl_scanRsp.rsv_user[3] 	= 0;
	tbl_scanRsp.rsv_user[4] 	= PROVIDER_MAIN;		//RD_EDIT: SEC : PROVIDER-SC: tbl_scanRsp.rsv_user[x]
	tbl_scanRsp.rsv_user[5] 	= PROVIDER_SUB;
	tbl_scanRsp.rsv_user[6] 	= VERSION_MAIN;
	tbl_scanRsp.rsv_user[7]	 	= VERSION_SUB;
	tbl_scanRsp.rsv_user[8] 	= 0;
	tbl_scanRsp.rsv_user[9] 	= 0;
	tbl_scanRsp.rsv_user[10] 	= 0;
...
//	uart_dma_enable(1, 1); 	//uart data in hardware buffer moved by dma, so we need enable them first
	uart_dma_enable(0, 0);	//RD_EDIT: uart_init
