...
const u16 factory_test_model_array[] = {		//RD_EDIT: Factory test mode
    SIG_MD_G_ONOFF_S, SIG_MD_LIGHTNESS_S, SIG_MD_LIGHT_CTL_S, SIG_MD_LIGHT_CTL_TEMP_S, SIG_MD_LIGHT_HSL_S, SIG_MD_LIGHT_XYL_S, RD_OPCODE_TYPE_SEND, RD_OPCODE_FAST_CREATE_ROOM, RD_OPCODE_TRAINING_TEST2_SEND,
#if (!DRAFT_FEAT_VD_MD_EN)
    SIG_MD_FW_UPDATE_S,
#endif
};
...
int mesh_provision_par_set(u8 *prov_pars)
{
	...
	#endif
//	rf_link_light_event_callback(LGT_CMD_PROV_SUC_EVE);			//RD_EDIT: disnable provision
