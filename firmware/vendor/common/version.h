...
#define MESH_PID_SEL		(RD_PID_TYPE)	//RD_EDIT: 0.1.THANH RD_PID_TYPE
	#if DU_ENABLE
#define MESH_VID		    DU_FW_VER       // in the du mode ,we will use to set version .
	#else
//RD_EDIT: 0.1.THANH FW_VERSION_TELINK_RELEASE
#define MESH_VID		   FW_VERSION_TELINK_RELEASE       // user can redefine  RD_VID_TYPE	//
	#endif
